...
# # arg1 = sys.argv[1]
arg1 = 'snp151_toIntersect_okok' # input file with HS coordinates
# # arg2 = sys.argv[2]
...
for my_chro in file_size_chrs_numpy:
    ...
    chro_hs_occrs = np.zeros(num_bins, dtype=int) # Create zero positions
    ...
    for hsens in chro_sens:
        ...
        bin_end   = math.floor(hs_end / bin_size)
        
        chro_hs_occrs[bin_start : bin_end+1] = True
    ...
    chro_out = {'chr':out_col1 , 'bin_sta': out_col2, 'bin_end': out_col3, 'occrs':chro_hs_occrs}
